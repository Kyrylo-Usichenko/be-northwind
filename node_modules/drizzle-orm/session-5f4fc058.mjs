...
import { Q as QueryPromise, ap as orderSelectedFields, al as Table, Z as SQL, a4 as Param, a6 as sql, aq as mapUpdateSet, V as mapRelationalRow, bg as QueryBuilder, ac as WithSubquery, ad as SelectionProxyHandler, bh as PgSelectBuilder } from './relations-c9e54a8f.mjs';
...
class PgRelationalQuery extends QueryPromise {
    ...
    _prepare(name) {
        ...
        return this.session.prepareQuery(builtQuery, undefined, name, (rawRows) => {
...
class PgSession {
    ...
    values(query) {
        return this.prepareQuery(this.dialect.sqlToQuery(query), undefined, undefined).values();
    }
}
...
//# sourceMappingURL=session-5f4fc058.mjs.map
